...
// 	IFNULL(ES.fmt_test_open_book,0)+ IFNULL(ES.fmt_home_class_work,0) +IFNULL(ES.fmt_other,0)+IFNULL(ES.smt_oral,0)+ IFNULL(ES.smt_practical,0)+ IFNULL(ES.smt_written,0)) AS 'exam_mark' ,
...
// 	IFNULL(SM.fmt_test_open_book,0)+ IFNULL(SM.fmt_home_class_work,0)+IFNULL(SM.fmt_other,0)+ IFNULL(SM.smt_oral,0)+ IFNULL(SM.smt_practical,0)+ IFNULL(SM.smt_written,0)) AS 'stu_mark'
