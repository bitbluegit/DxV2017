...
$sql = "SELECT * FROM clg_bonafide ORDER BY sr_no DESC LIMIT 1";
            ...
            <div class="wrapper">
                ...
                <div class="row txt-justify">
                    <p>
                        ...
                        was a bonafied student of our school studying in Year
                        <span class="dashed-fields w200"><b>&nbsp;<?=$year?></b></span> with
