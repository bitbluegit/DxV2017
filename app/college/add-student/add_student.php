...
// get gr number 
$gr_query="select CD.`Gr_num` from clg_details AS CD ORDER BY CD.`GR_num` DESC LIMIT 1 ";
...
<div class="bg-white overflow-x box-shadow margin-bottom30  ">
	...
	<!-- Expense Form -->
	<form  name="adm_form"  method="post" action="addStudentCtrl.php" onsubmit="return validateForm()" enctype="multipart/form-data">

		<!-- dummy image -->
		<div class="col m12 l4 ">
			<div id="stu_img_place">
...
<div class="col m12 l4">
	...
	<input type="number" id="gr_no" name="gr_no"  class="full-width" title="Enter Student Gr Number.">
</div>
...
<div class="col m12 l4">
	...
	<input type="number" id="rollno" name="rollno"  class="full-width" title="Enter Student Gr Number.">
</div>
...
<div class="col m12 l4">
	...
	<input type="text" id="student_name" name="student_name" class="full-width" title="Enter Student Name.">
</div>
...
<div class="col m12 l4">
	...
	<select  id="state" name="state" class="full-width" title="Select Your Residence State">
...
<div class="col m12 l4">
	...
	<input type="text" id="per_address" name="per_address" class="full-width" title="Enter Student Address">
</div>
...
<div class="col m12 l4">
	...
	<input type="text" id="f_occupation" name="f_occupation" class="full-width" title="Enter Student Address">
</div>

<!--mother qualification -->
<div class="col m12 l4">
	<label for="m_qualification" class="font-weight100 small-caps full-width required">Mother Qualification</label>
	<input type="text" id="m_qualification" name="m_qualification" class="full-width" title="Enter Student Address">
</div>
...
<div class="col m12 l4">
	...
	<input type="text" id="m_occupation" name="m_occupation" class="full-width" title="Enter Student Address">
</div>
...
<div class="col m12 l4">
	...
	<input type="number" id="contact_number" name="contact_number" class="full-width" title="Enter Contact Number">
</div>

<!--aadhar number -->
<div class="col m12 l4">
	<label for="aadhar_no" class="font-weight100 small-caps full-width required">Aadhar Number</label>
	<input type="number" id="aadhar_no" name="aadhar_no" class="full-width" title="Enter Student Aadhar number">
</div>

<!--gender -->
<div class="col m12 l4">
	<label for="documents" class="font-weight100 small-caps full-width">Documents</label>
	<select id="documents" name="documents" class="full-width" title="Select Student Gender.">
...
<div class="col m12 l4">
   ...
   <select name="cName" id="cName" class="full-width" onchange="getSection()" title="Select Fee Frequency" required>
     <option value="" disabled selected>Select One</option>
    </select>
</div>
...
<div class="col m12 l4">
 ...
 <select name="section" id="section" class="full-width" title="Select Fee Frequency" required>
    <option value="" disabled selected>Select One</option>
</select>
...
<div class="col m12 l4">
	...
	<input type="text" id="last_school" name="last_school" class="full-width" placeholder="Enter Last School" title="Enter Student Last School">
</div>

<!--date of addmission -->
<div class="col m12 l4">
	<label for="admission_date" class="font-weight100 small-caps full-width">Admission Date</label>
	<input type="date" id="admission_date" name="admission_date" class="full-width" title="Select Admission Date">
</div>
...
<div class="col m12 l4">
	...
	<select  id="type_of_adm" name="type_of_adm" class="full-width" >
...
function getCourseName() {
    ...
    function getSection(){
        ...
        crs  = elementByIdValue('course'),
        year = elementByIdValue('year'),
        cname = elementByIdValue('cName');
        callBackFunction =function(res){
            elementById('section').innerHTML = res;
        }; 

        AjaxPost('../db/getSection.php',{mdm:mdm,crs:crs,year:year,cname:cname},callBackFunction,'txt');
    }
