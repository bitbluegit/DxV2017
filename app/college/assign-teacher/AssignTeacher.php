...
/*  .view-picker {margin-top: 20px; width: 29%; margin: 10px auto; line-height: 30px; border: 1px solid #ccc; font-variant: small-caps;
                    ...
                    <div class="span-right" >
                        ...
                        <section class="container">
                            ...
                            ******************************************************** -->                            
                            ...
                            $getExamForClassQuery = mysqli_query($con,"SELECT CE.mdm, CE.cors, CE.corsName,CE.yr,CE.sec,CE.exam_name,CE.exam_id FROM clg_exams CE
                                ORDER BY FIELD(CE.`mdm`,'English','Hindi','Marathi') ") ;   
 ...
 // Ajax Post Method 
        ...
        // document.getElementById('exam-subject-det').innerHTML = res ;
                        ...
                        if( corsName != 'default' && sec != '' ){
                            var params = { mdm : mdm , yr : yr ,cors : cors , corsName : corsName , sec : sec };
