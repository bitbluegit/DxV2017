...
<div class="bg-white overflow-x box-shadow margin-bottom30  ">
    ...
    <form class="row" id="row">
        ...
        <div class="col m12 l4">
            ...
            <input type="text" id="particular" name="particular" class="full-width"  title="Enter particular name e.g. pen, stationary etc.">
        </div>

        <!-- Amount -->
        <div class="col m12 l4">
            <label for="amount" class="font-weight100 small-caps full-width">Amount</label>
            <input type="text" id="amount" name="amount" class="full-width" title="Enter particular amount.">
        </div>

        <!-- Add Button -->
        <div class="col m12 l4">
            <label>&nbsp;</label><br>
            <button type="button" onclick="addRow()" class="btn btn-blue" title="Add more particular.">
        ...
        <!-- Dynamic Particular -->
            ...
            <script type="text/javascript">
                function addRow(){
                 ...
                 x.setAttribute("name", "particulat");
                 x.setAttribute("class", "full-width")
                 // x.setAttribute("value", "Hello World!");
                 document.getElementById('dynamicperticular').appendChild(x);

                 var y = document.createElement("INPUT");
                 y.setAttribute("type", "number");
                 y.setAttribute("name", "amount");
                 y.setAttribute("class", "full-width")
                 // x.setAttribute("value", "Hello World!");
                 document.getElementById('dynamicamount').appendChild(y);

                 var z = document.createElement("BUTTON");
                 z.setAttribute("type","btn");
                 z.setAttribute("name", "add")
                 z.setAttribute("value","add");
                 z.setAttribute("class", "btn btn-blue");
                 document.getElementById('dynamicbtn').appendChild(z);

                 var a = document.createElement("BUTTON");
                 a.setAttribute("type","btn");
                 a.setAttribute("name", "add")
                 a.setAttribute("value","add");
                 a.setAttribute("class", "btn btn-red");
                 document.getElementById('dynamicbtn').appendChild(a);
             }
         </script>