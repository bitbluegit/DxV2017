	...
	<section  id="enroll-filter" name="enroll-filter" >
		...
		<div class="row">
			...
			<div class="col m12 l4 pad-top20 txt-left">
				<button type="button" class="btn bg-grey txt-ash full-width" id="createClassSubmit" onclick="getStudentDetailForBonafide(this)" style=" margin-top: 3px;">
...
***************************** -->
<section class="bg-white overflow-x box-shadow margin-bottom30" id="bonafide-block">
