...
<div class="bg-white overflow-x box-shadow margin-bottom30  ">
	...
	<!-- Expense Form -->
	<form  name="adm_form" "class="row" method="post" action="addStudentCtrl.php" onsubmit="return validateForm()">

		<!-- dummy image -->
		<div class="col m12 l4">
			<div id="stu_img_place">
				<img src="../../../assets/img/dummy_student.png"   alt="Student Image" class="stu_img_cls dummyimg">
			</div>
    ...
    if (file.type.match(/image.*/)) {
        ...
        reader.onload = function (readerEvent) {
        	...
        	image.onload = function (imageEvent) {
                ...
                document.getElementById(place_img_to).innerHTML = domObjectToString(canvas);
            }
