                ...
                <div class="bg-white overflow-x box-shadow margin-bottom30  ">
                    ...
                    <form class="row">
                        ...
                        <div class="col m12 l4">
                            ...
                            <input type="date" id="startdate" class="full-width" title="Enter User Name.">
                        </div>
                        
                        <!--End Date -->
                        <div class="col m12 l4">
                            <label for="enddate" class="font-weight100 small-caps full-width">End Date</label>
                            <input type="date" id="enddate" class="full-width" title="Enter Password.">
                        </div>
                        
                        <!-- Name -->
                        <div class="col m12 l4">
                            <label for="name" class="font-weight100 small-caps full-width">Name</label>
                            <input type="text" id="name" class="full-width" title="Enter student name.">
                        </div>
                        
                        <!-- enroll no -->
                        <div class="col m12 l4">
                            <label for="enroll" class="font-weight100 small-caps full-width">Enroll No.</label>
                            <input type="number" id="enroll" class="full-width" title="Enter Student Enroll No..">
                        </div>
                        ...
                        <div class="col m12 l4">
                            ...
                            <select id="standard" class="full-width" title="Select Your Standatd.">
                                <option>Select One</option>
                                <option>School-user</option>
                            </select>
                        </div>
