	...
	<form method="post" action="" id="addHoliday" onsubmit="return false">
		...
		<div class="row">
			...
			<div class="col m12 l4">
				...
				<input type="text" id="title" name="title" class="full-width" title="Enter Holiday Title." placeholder ="Enter Holiday Title." required="required">
