...
$sql1 = "
		 (
			SELECT AD.name, AT.Gr_num, US.Name ,US.Medium, US.Std ,US.Section ,AT.Reciept 
		...
		(
			SELECT AD.name ,ST.Gr_num ,US.Name ,US.Medium ,US.Std ,US.Section ,ST.Reciept,ST.Amount,ST.fee_type, 
